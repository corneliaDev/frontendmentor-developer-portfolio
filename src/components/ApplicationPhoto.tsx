export default function ApplicationPhoto() {
  return (
    <div className="relative tablet:absolute -mt-16 tablet:mt-0 top-0 tablet:top-0 tablet:right-0 desktop:right-[10.3125rem] desktop:w-[27.8125rem] h-[23,9375rem] w-[10.875rem] desktop:h-[45rem] tablet:w-[20.125rem] tablet:h-[37.5rem]">
      <picture>
        <source
